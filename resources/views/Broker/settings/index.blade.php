                                                    ...
                                                    <form action="" method="post" >
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="btn btn-primary" type="button" onclick="copyGalleryUrl()">@lang('Copy URL')</button>
                                                                <input type="text" class="form-control" id="galleryName" disabled value="{{ env('APP_URL') }}/ar/broker/Gallary/{{ $gallery->gallery_name }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 mb-3" style="padding-right: 33px;">
                                                            <div class="row">
                                                                <div class="p-0 m-0">
                                                                    ...
                                                                    <div class="d-flex " style="margin-top: 10px">
                                                                        ...
                                                                        <input type="text" class="form-control edit-gallery-name"
                                                                            id="gallery_name" placeholder="officename" name="gallery_name"
                                                                             value="{{ $gallery->gallery_name }}"
                                                                            oninput="validateName(this)">
                                                                        <input hidden name="broker_id_for_gallery"
                                                                            value="{{ $gallery->id }}" />

                                                                            <input type="text" class="form-control" id="galleryName" disabled value="{{ env('APP_URL') }}/ar/broker/Gallary/">
