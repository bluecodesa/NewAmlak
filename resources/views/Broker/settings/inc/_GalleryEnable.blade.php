                ...
                <div class="card-body">
                    <form action="{{ route('Broker.Gallery.create')}}" method="post" id="galleryForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('gallery_name') is-invalid @enderror" id="galleryName" name="gallery_name" value="{{ old('gallery_name', explode('@', auth()->user()->email)[0]) }}" required>
                            @error('gallery_name')
