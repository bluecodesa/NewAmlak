...
@section('content')
    <div class="content-wrapper">
        ...
        @endif
           <div class="card">
            <div class="card-body">
                <form action="{{ route('Broker.Gallary.showInterests') }}" class="row" method="GET" id="interestsForm">


                    <div class="col-12 col-md-4 mb-3">
                        <span>@lang('status')</span>
                        <select class="form-select form-control-sm" id="status_filter"
                            name="status_filter" onchange="reloadInterests()">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <select class="form-select form-control-sm " id="prj_filter" required=""
                            name="prj_filter" style="width:95%!important" onchange="reloadInterests()">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <select class="form-select form-control-sm" id="prop_filter" required=""
                            name="prop_filter" style="width:95%!important" onchange="reloadInterests()">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        <span>@lang('Unit')</span>
                        <select class="form-select form-control-sm" id="unit_filter" required=""
                            name="unit_filter" style="width:95%!important" onchange="reloadInterests()">
                    ...
                    <div class="col-12 col-md-4 mb-3">
                        ...
                        <select class="form-select form-control-sm" id="client_filter" required=""
                            name="client_filter" style="width:95%!important"
