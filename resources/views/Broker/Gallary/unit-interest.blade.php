                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                <form action="{{ route('Broker.Gallary.showInterests') }}" method="GET"
                                    id="interestsForm">
                                    ...
                                    <div class="row" style="align-items: end;">
                                        ...
                                        <div class="w-auto  p-0 ml-2">
                                            ...
                                            <select class="form-control form-control-sm " id="prj_filter" required=""
                                        ...
                                        <div class="w-auto  p-0 ml-2">
                                            ...
                                            <select class="form-control form-control-sm" id="prop_filter" required=""
                                        ...
                                        <div class="w-auto  p-0 ml-2">
                                            <span>@lang('Unit')</span>
                                            <select class="form-control form-control-sm" id="unit_filter" required=""
                                        ...
                                        <div class="w-auto  p-0 ml-2">
                                            ...
                                            <select class="form-control form-control-sm" id="client_filter" required=""
