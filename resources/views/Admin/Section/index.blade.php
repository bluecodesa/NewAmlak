        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="row p-1 mb-1">
                    <div class="col-12">
                        <h5 class="card-header">@lang('sections') </h5>
                    </div>
                    <hr>
                    <div class="col-12">
                        <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap d-flex">
                                            ...
                                            @if (Auth::user()->hasPermission('create-sections'))
                                                <div class="btn-group">
                                                    <a href="{{ route('Admin.Sections.create') }}" type="button"
                                                        class="btn btn-primary">
                                                        <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                                                class="d-none d-sm-inline-block">@lang('Add New Section')</span></span>
                                                    </a>
                                                </div>
                                            @endif
                                        </div>
                                            ...
                                            <div class="dropdown-menu" style="">
                                                @if (Auth::user()->hasPermission('update-sections'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('Admin.Sections.edit', $section->id) }}">@lang('Edit')</a>
                                                @endif
