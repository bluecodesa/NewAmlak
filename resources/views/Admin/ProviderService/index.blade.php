        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="row p-1 mb-1">
                    <div class="col-12">
                        <h5 class="card-header">@lang('Provider Services') </h5>
                    </div>
                    <hr>
                    <div class="col-12">
                        <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap d-flex">
                                            ...
                                            @if (Auth::user()->hasPermission('create-sections'))
                                                <div class="btn-group">
                                                    <a href="{{ route('Admin.ProviderServices.create') }}" type="button"
                                            ...
                                            <div class="dropdown-menu" style="">
                                                @if (Auth::user()->hasPermission('update-sections'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('Admin.ProviderServices.edit', $wallet->id) }}">@lang('Edit')</a>
                                                @endif
                                                ...
                                                @if (Auth::user()->hasPermission('delete-sections'))
                                                    ...
                                                    <form id="delete-form-{{ $wallet->id }}"
                                                        action="{{ route('Admin.ProviderServices.destroy', $wallet->id) }}"
