        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="row p-1 mb-1">
                    <div class="col-12">
                        <h5 class="card-header">@lang('Ticket Type') </h5>
                    </div>
                    <hr>
                    <div class="col-12">
                        <div class="row">
                                                ...
                                                <div class="btn-group">
                                                    <a href="{{ route('Admin.SupportTickets.createTicketType') }}"
                                                        ...
                                                        <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                                                class="d-none d-sm-inline-block">@lang('Add New Ticket Type')</span></span>
                                                    </a>
                                                </div>
                                            @endif
                                        </div>
                                            ...
                                            <div class="dropdown-menu" style="">
                                                @if (Auth::user()->hasPermission('update-support-ticket-type'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('Admin.SupportTickets.editTicketType', $ticket->id) }}">@lang('Edit')</a>
                                                @endif
