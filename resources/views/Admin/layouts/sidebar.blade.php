            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    <a href="index.html" class="waves-effect">
                        <i class="icon-accelerator"></i><span
                            class="badge badge-success badge-pill float-right">9+</span> <span> لوحة التحكم </span>
                    </a>
                </li>
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i
                        ...
                        "></i><span> ادارة المشتركين <span
                                class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="email-inbox.html">قائمة المشتركين</a></li>
                        <li><a href="email-read.html">قائمة الفواتير</a></li>
                        <li><a href="{{ route('SubscriptionTypes.index') }}">الاشتركات</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i
                            class="mdi mdi-bank-minus
                        "></i><span> ادارة انواع المستخدمين <span
                                class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                    <ul class="submenu">
                        <li><a href="{{ route('roles.index') }}">قائمة انواع المستخدمين</a></li>
                        <li><a href="">قائمة الصلاحيات</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="icon-diamond"></i> <span> Advanced UI
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="icon-todolist-check"></i><span> Forms
                            <span class="badge badge-pill badge-danger float-right">8</span> </span></a>
                    <ul class="submenu">
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="icon-spread"></i><span> Tables <span
                                class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
                        </span></a>
                    <ul class="submenu">
                ...
                <li>
                    <a href="javascript:void(0);" class="waves-effect"><i class="icon-coffee"></i> <span> Icons <span
