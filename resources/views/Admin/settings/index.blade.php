                                            ...
                                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                                ...
                                                <div class="col-md-12 ArFont">
                                                                      ...
                                                                      <input type="hidden" name="_method" value="POST">
                                                                       ...
                                                                       <div class="col-sm-12 col-md-6">
                                                                           <div id="dataTable-1_filter" class="dataTables_filter">
                                                                               <label>
                                                                                   <input type="search" class="form-control form-control-sm" placeholder="بحث" aria-controls="dataTable-1">
                                                                               </label>
                                                                           </div>
                                                                       </div>
                                                                   </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="الاشعار: activate to sort column descending">الاشعار</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="Whatsapp: activate to sort column ascending">Whatsapp</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Email</th>
                                                    <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="SMS: activate to sort column ascending">SMS</th></tr>
                                                </thead>
                                                <tbody>
                                                    <tr role="row" class="odd">
                                                        <td class="sorting_1"> استحقاق موعد دفعة إيجار جديدة</td>
                                                          <td> <input type="checkbox" id="whatsapp" name="whatsapp">
                                                            ...
                                                            <input type="checkbox" id="email" name="email">
                                                               ...
                                                               <td>
                                                                ...
                                                                <input type="checkbox" id="email"  name="sms">
                                                                </td>
                                                                </tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="dataTables_info" id="dataTable-1_info" role="status" aria-live="polite"></div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="dataTable-1_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="dataTable-1_previous"><a href="#" aria-controls="dataTable-1" data-dt-idx="0" tabindex="0" class="page-link">&lt;</a></li><li class="paginate_button page-item active"><a href="#" aria-controls="dataTable-1" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item next disabled" id="dataTable-1_next"><a href="#" aria-controls="dataTable-1" data-dt-idx="2" tabindex="0" class="page-link">&gt;</a></li></ul></div></div></div></div>
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">@lang('save')</button>
                                                                    <button type="reset" class="btn btn-secondary waves-effect m-l-5">@lang('Cancel')</button>
                                                             </form>
                                                                    </div>
