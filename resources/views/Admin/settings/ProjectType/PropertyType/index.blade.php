        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="row p-1 mb-1">
                    <div class="col-12">
                        <h5 class="card-header">@lang('Property Types') </h5>
                    </div>
                    <hr>
                    <div class="col-12">
                        <div class="row">
                                                ...
                                                <div class="btn-group">
                                                    <a href="{{ route('Admin.PropertyType.create') }}"
                                                        ...
                                                        <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                                                class="d-none d-sm-inline-block">@lang('Add New Property Type')</span></span>
                                                    </a>
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                @if (Auth::user()->hasPermission('update-real-estate-settings'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('Admin.PropertyType.edit', $type->id) }}">@lang('Edit')</a>
                                                @endif
