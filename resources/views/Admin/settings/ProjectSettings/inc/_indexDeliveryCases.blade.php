<div class="row p-1 mb-1">
    <div class="col-12">
        <h5 class="card-header">@lang('Delivery Cases') </h5>
    </div>
    <hr>
    <div class="col-12">
        <div class="row">
                        ...
                        <div class="dt-buttons btn-group flex-wrap d-flex">
                            <div class="btn-group">
                                <button onclick="exportToExcel()"
                                    class="btn btn-outline-primary btn-sm waves-effect me-2" type="button"><span><i
                                            class="ti ti-download me-1 ti-xs"></i>Export</span></button>
                            </div>
                            @if (Auth::user()->hasPermission('create-support-ticket-type'))
                                <div class="btn-group">
                                    <a href="{{ route('Admin.ProjectSettings.createDelivery-case') }}"
                                        class="btn btn-primary">
                                        <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                                class="d-none d-sm-inline-block">@lang('Add New Delivery Case')</span></span>
                                    </a>
                                </div>
                            @endif
                        </div>
...
<div class="table-responsive text-nowrap">
    <table class="table" id="table">
        ...
        <tbody class="table-border-bottom-0">
            @forelse ($deliveryCases as  $deliveryCase)
                <tr>
                    {{-- <th>{{ $index + 1 }}</th> --}}
                    <td>{{ $deliveryCase->name }}</td>
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="">
                                ...
                                @endif
                                <a href="javascript:void(0);" onclick="handleDelete('{{ $deliveryCase->id }}')"
