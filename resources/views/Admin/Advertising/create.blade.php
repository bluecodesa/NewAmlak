    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('Admin.Advertisings.store') }}" class="row" method="POST"
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            ...
                            <input class="form-control" type="file" id="content" name="content" required
                                accept="image/*,video/*,.pdf,.docx" required>
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            ...
                            <input class="form-control" type="number" id="ad_duration" name="ad_duration" required
                                readonly>
                        </div>
                        <div class="col-12">
