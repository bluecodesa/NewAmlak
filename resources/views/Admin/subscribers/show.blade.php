                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <img class="rounded mr-2" alt="User image" style="width: 100%; height: 86%;"
                                            src="@if ($subscriber->office_id) {{ $subscriber->OfficeData->company_logo ?? 'https://www.svgrepo.com/show/29852/user.svg' }}
                                                @elseif ($subscriber->broker_id)
                                                    {{ $subscriber->BrokerData->broker_logo ?? 'https://www.svgrepo.com/show/29852/user.svg' }} {{-- Use asset helper --}} @endif"
