                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-4 text-left">
                                            <img src="{{ url(LaravelLocalization::getCurrentLocale() === 'ar' && $sitting->icon_ar ? $sitting->icon_ar : ($sitting->icon_en ? $sitting->icon_en : '')) }}"
                                    ...
                                    @php
                                        if ($invoice->OfficeData != null) {
                                            ...
                                            $name = $invoice->OfficeData->UserData->name ?? '-';
                                            $presenter_number = $invoice->OfficeData->mobile ?? '-';
                                            $city = $invoice->OfficeData->CityData->name ?? '-';
                                        }
                                    @endphp
                                    <div class="row">
