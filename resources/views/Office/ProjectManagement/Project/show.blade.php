                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="dt-buttons btn-group flex-wrap d-flex">
                                                        ...
                                                        @if (Auth::user()->hasPermission('create-building'))
                                                        <div class="btn-group">
                                                            <a href="{{ route('Office.Project.CreateProperty', $project->id) }}" class="btn btn-primary">
                                                                <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="dt-buttons btn-group flex-wrap d-flex">
                                                        ...
                                                        <div class="btn-group">
                                                            <a href="{{ route('Office.Project.CreateUnitProject', $project->id) }}" class="btn btn-primary">
                                                                <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
                                                                        class="d-none d-sm-inline-block">@lang('Add')</span></span>
                                                            </a>
