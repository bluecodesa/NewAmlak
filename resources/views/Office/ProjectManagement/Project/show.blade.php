        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="nav-align-top nav-tabs-shadow mb-4">
                <ul class="nav nav-tabs nav-fill" role="tablist">
                  ...
                  <li class="nav-item">
                    <button
                      ...
                      role="tab"
                      data-bs-toggle="tab"
                      data-bs-target="#navs-justified-properties"
                      aria-controls="navs-justified-properties"
                      aria-selected="false">
                      <i class="tf-icons ti ti-building-warehouse ti-xs me-1"></i> @lang('properties')
                    </button>
                  </li>
                  <li class="nav-item">
                        <button
                ...
                <div class="tab-content">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="dt-buttons btn-group flex-wrap d-flex">
                                                            ...
                                                            @if (Auth::user()->hasPermission('create-unit'))
                                                                <div class="btn-group">
                                                                    <a href="{{ route('Office.Project.CreateUnitProject', $project->id) }}"
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    @if (Auth::user()->hasPermission('create-unit'))
                                                                        <li><a class="dropdown-item"
                                                                                href="{{ route('Office.Project.CreateUnitProject', $project->id) }}">@lang('Add unit')</a>
                                                                        </li>
                  ...
                  <div class="tab-pane fade" id="navs-justified-properties" role="tabpanel">
                    <!-- property table -->
                    <div class="card">
                        <div class="card-header">
                                                    ...
                                                    <div class="dt-buttons btn-group flex-wrap d-flex">
                                                        ...
                                                        {{-- <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                @if (Auth::user()->hasPermission('create-building'))
                                                                    <li><a class="dropdown-item"
                                                                            href="{{ route('Office.Project.CreateProperty', $project->id) }}">@lang('Add new property')</a>
                                                                    </li>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" style="">
                                                                {{-- @if ($property->is_divided == 1)
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('Office.Property.show', $property->id) }}">@lang('Add units')</a>
                                                                @endif --}}

                                                                <a class="dropdown-item"
                                                                    href="{{ route('Office.Property.show', $property->id) }}">@lang('Show')</a>
                                                                @if (Auth::user()->hasPermission('update-building'))
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('Office.Property.edit', $property->id) }}">@lang('Edit')</a>
                                                                @endif
