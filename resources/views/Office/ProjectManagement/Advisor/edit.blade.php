    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-6">
                    <h4 class=""><a href="{{ route('Office.home') }}" class="text-muted fw-light">@lang('dashboard') /</a>
                        <a href="{{ route('Office.Advisor.index') }}" class="text-muted fw-light">@lang('advisors')
                        </a> /
                        @lang('Edit')
                    </h4>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('Office.Advisor.update', $advisor->id) }}" method="POST" class="row">
                        @csrf
                        @method('PUT')
                        <input type="text" name="key_phone" hidden value="{{ $advisor->key_phone ?? '966' }}"
                            id="key_phone">
                        ...
                        <div class="col-12 mb-3 col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                {{ $advisor->key_phone ?? config('translatable.phones')[0] }}
                                </button>
