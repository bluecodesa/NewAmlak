                                    ...
                                    <div
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap d-flex">
                                            ...
                                            @if (Auth::user()->hasPermission('create-owner'))
                                                <div class="btn-group">
                                                    <a href="{{ route('Office.Wallet.create') }}" class="btn btn-primary">
                        ...
                        <tbody class="table-border-bottom-0">
                            @forelse ($wallets as $Wallet)
                                <tr>
                                    ...
                                    <td>{{ $Wallet->is_default == 1 ? __('Yes') : __('No') }}</td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                @if (Auth::user()->hasPermission('update-owner'))
                                                    <a class="dropdown-item"
                                                        href="{{ route('Office.Wallet.edit', $Wallet->id) }}">@lang('Edit')</a>
                                                @endif
                                                ...
                                                @if (Auth::user()->hasPermission('delete-owner'))
                                                    ...
                                                    <form id="delete-form-{{ $Wallet->id }}"
                                                        action="{{ route('Office.Wallet.destroy', $Wallet->id) }}"
