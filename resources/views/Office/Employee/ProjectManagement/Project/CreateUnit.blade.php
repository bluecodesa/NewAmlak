            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <h4 class=""><a href="{{ route('Office.home') }}" class="text-muted fw-light">@lang('dashboard') /</a>
                        ...
                        <a href="{{ route('Office.Project.show', $Project->id) }}" class="text-muted fw-light">
                            {{ $Project->name }} </a> /
                        @lang('Add unit')
                    </h4>
                </div>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
                        ...
                        {{-- الوصف --}}
                                        ...
                                        <form action="{{ route('Office.Project.StoreUnitProject', $id) }}" method="POST" class="row"
                                                ...
                                                <select class="form-select" name="city_id" id="CityDiv" required>
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            ...
                                                            {{ $Project->CityData->id == $city->id ? 'selected' : '' }}>
                                                            {{ $city->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-12 mb-3">
                                                ...
                                                <input type="text" required name="location" id="myAddressBar" class="form-control"
                                                    placeholder="@lang('location name')" value="{{ $Project->location }}" />
                                            </div>
                                                ...
                                                <select class="form-select" name="property_type_id" required>
                                                    ...
                                                    @foreach ($types as $type)
                                                        <option value="{{ $type->id }}"
                                                            {{ $Project->Project_type_id == $type->id ? 'selected' : '' }}>
                                                            {{ $type->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
