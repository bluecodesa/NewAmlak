    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-6">
                    <h4 class="">
                        <a href="{{ route('Employee.home') }}" class="text-muted fw-light">@lang('dashboard') /</a>
                        @lang('Units')
                    </h4>
                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="dt-buttons btn-group flex-wrap d-flex">
                                                ...
                                                @if (Auth::user()->hasPermission('create-unit'))
                                                    <a href="{{ route('Employee.Unit.create') }}"
                        ...
                        <table class="table" id="table">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th>@lang('The Responsible Employee')</th>
                                    <th>@lang('property')</th>
                                                ...
                                                <div class="dropdown-menu" style="">
                                                    ...
                                                    @if (Auth::user()->hasPermission('delete-unit'))
                                                        ...
                                                        <form id="delete-form-{{ $unit->id }}"
                                                            action="{{ route('Employee.Unit.destroy', $unit->id) }}"
