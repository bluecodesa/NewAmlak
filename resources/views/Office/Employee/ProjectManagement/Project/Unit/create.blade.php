            ...
            <div class="row">
                <div class="col-6">
                    <h4 class=""><a href="{{ route('Employee.home') }}" class="text-muted fw-light">@lang('dashboard') /</a>
                        <a href="{{ route('Employee.Unit.index') }}" class="text-muted fw-light">@lang('Units') </a> /
                        @lang('Add unit')
                    </h4>
                </div>
                ...
                <div class="nav-align-top nav-tabs-shadow mb-4">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="navs-justified-home" role="tabpanel">
                        ...
                        <form action="{{ route('Employee.Unit.store') }}" method="POST" class="row"
                                                ...
                                                <select class="form-select " id="CityDiv" name="city_id" required>
                                                    ...
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            data-url="{{ route('Employee.Employee.GetDistrictsByCity', $city->id) }}">
                                                            {{ $city->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
...
{{-- نهايه الوصف --}}
    @push('scripts')
        <script>
            ...
            var path = "{{ route('Employee.Project.autocompleteProject') }}";
