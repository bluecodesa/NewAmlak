                                    ...
                                    <div
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap d-flex">
                                            ...
                                            {{-- @if (Auth::user()->hasPermission('create-sections')) --}}
                                                <div class="btn-group">
                                                    <a href="{{ route('Office.Setting.createFalLicense') }}" type="button"
                                            ...
                                            <div class="dropdown-menu" style="">
                                                {{-- @if (Auth::user()->hasPermission('update-sections')) --}}
                                                    <a class="dropdown-item"
                                                        href="{{ route('Office.Setting.editFalLicense', $falLicense->id) }}">@lang('Edit')</a>
                                                {{-- @endif --}}
                                                ...
                                                {{-- @if (Auth::user()->hasPermission('delete-sections')) --}}
                                                    ...
                                                    <form id="delete-form-{{ $falLicense->id }}"
                                                        action="{{ route('Office.Setting.deleteFalLicense', $falLicense->id) }}"
