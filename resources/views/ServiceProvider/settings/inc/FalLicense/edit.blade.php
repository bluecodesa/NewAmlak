    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-6 ">
                    <h4 class=""><a href="{{ route('Admin.home') }}" class="text-muted fw-light">@lang('dashboard') /</a>
                        <a href="{{ route('Office.Setting.index') }}" class="text-muted fw-light">@lang('Settings')
                        </a> /
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('Office.Setting.updateFalLicense', $falLicense->id) }}" method="POST" class="row">
                        @csrf
                        @method('PUT')
                           ...
                           <div class="col-md-4 mb-3 col-12">
                            ...
                            @php
                            $licenseDate = Auth::user()->UserOfficeData->license_date;
                            @endphp
                            <div class="col-sm-12 col-md-4 mb-3">
