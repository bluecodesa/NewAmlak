        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">@lang('Services')</h5>
                </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" style="">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('ServiceProvider.ProviderService.edit', $providerService->id) }}">@lang('Edit')</a>



                                                    <a href="javascript:void(0);"
                                                        onclick="handleDelete('{{ $providerService->id }}')"
                                                        class="dropdown-item delete-btn">@lang('Delete')</a>
                                                    <form id="delete-form-{{ $providerService->id }}"
                                                        action="{{ route('Office.Advisor.destroy', $providerService->id) }}"
