    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-6 ">
                    ...
                    <h4 class=""><a href="{{ route('Admin.home') }}" class="text-muted fw-light">@lang('dashboard') /</a>
                        <a href="{{ route('ServiceProvider.Tickets.index') }}" class="text-muted fw-light">@lang('Tickets')
                        </a> /
                        @lang('Add New Ticket')
                    </h4>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('ServiceProvider.Tickets.store') }}" method="POST" class="row"
