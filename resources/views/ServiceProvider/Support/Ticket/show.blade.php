            ...
            <div class="row">
                <div class="col-6">
                    <h4 class="">
                        ...
                        <a href="{{ route('ServiceProvider.Tickets.index') }}" class="text-muted fw-light">@lang('Tickets')</a> /
                        @lang('View Ticket')
                    </h4>
                </div>
            </div>
                                        ...
                                        <div class="list-group">
                                            ...
                                            @if (Auth::user()->hasPermission('update-support-ticket-user'))
                                                <div class="mt-4">
                                                    ...
                                                    <form id="commentForm"
                                                        action="{{ route('ServiceProvider.tickets.addResponse', $ticket->id) }}"
                                                        method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="mb-3">
                                                            <label for="response"
                                                                class="form-label">@lang('comment')</label>
                                                    ...
                                                    @if ($ticket->status === 'closed') disabled @endif required></textarea> --}}
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="attachment"
                                                                class="form-label">@lang('file')</label>
