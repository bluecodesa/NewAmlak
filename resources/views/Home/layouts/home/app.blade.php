                        ...
                        @guest
                            ...
                            <a href="" class="btn btn-primary" target="_blank" data-bs-toggle="modal"
                                data-bs-target="#addSubscriberModal"><span
                                    class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span>
                                <span class="d-none d-md-block">سجل معنا الأن</span></a>
                        @endguest
                        @auth

                            <a href="{{ route('Admin.home') }}" class="btn btn-primary" target="_blank"><span
                                    class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span><span
                            ...
                            <a href="{{ route('logout') }}"
                                ...
                                class="btn btn-primary" target="_blank"><span
                                    class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span><span
                                    class="d-none d-md-block">تسجيل الخروج</span></a>
