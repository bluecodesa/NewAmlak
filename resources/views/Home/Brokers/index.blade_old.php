                    ...
                    <div class="row gap-3" style="align-items: end;">
                        ...
                        <div class="col-12 p-0 ml-2">
                            ...
                            <select class="form-control form-control-sm" id="city_filter" name="city_filter">
                                ...
                                <option value="{{ $id }}" data-url="{{ route('Broker.Gallary.GetDistrictByCity', $id) }}" {{ $cityFilter == $id ? 'selected' : '' }}>
                                    {{ $uniqueNames[$index] }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 p-0 ml-2">
                            ...
                            <select class="form-control form-control-sm" id="district_filter" name="district_filter">
                                ...
                                <option value="{{ $district->district_id }}" {{ $districtFilter == $district->district_id ? 'selected' : '' }}>
