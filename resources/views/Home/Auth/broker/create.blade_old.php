            ...
            <div class="card-body px-5"> <!-- Adjusted width -->
                ...
                <form action="{{ route('Home.Brokers.CreateBroker') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="position:relative">
                                ...
                                <input type="tel" class="form-control" id="mobile" minlength="9" maxlength="9" pattern="[0-9]*" oninvalid="setCustomValidity('Please enter 9 numbers.')" onchange="try{setCustomValidity('')}catch(e){}" placeholder="599123456" name="mobile" required="" value="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <label for="password_confirmation"> @lang('Confirm Password') <span class="text-danger">*</span></label> <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-4 mb-6">
                            ...
                            <img id="broker_logo_preview" src="url('HOME_PAGE/img/avatars/14.png')" class="d-flex mr-3 rounded-circle" height="64" style="cursor: pointer;" />
