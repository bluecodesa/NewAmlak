        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('Home.PropertyFinders.CreateNewPropertyFinder') }}"
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="basic-default-name"
                                         name="name" placeholder="@lang('Name')" value="{{ $newPropertyFinder->name }}" readonly required>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="email">@lang('Email')<span class="text-danger">*</span></label>
                                        <input type="email" class="form-control" id="register_email" name="email" value="{{ $newPropertyFinder->email }}" readonly placeholder="@lang('Email')" required>
                                    </div>

                                    <div class="col-md-6 col-12 mb-3">
                                        <label for="id_number" class="form-label">@lang('id number')<span
                                            class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="id_number" name="id_number" value="{{ $newPropertyFinder->id_number }}" readonly required>
                                    </div>
