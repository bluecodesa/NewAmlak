<div id="filtered-results">
    ...
    @foreach ($units as $unit)
        ...
        <div class="col-sm-12 p-1">
            ...
            <div class="card-single">
                <div class="card d-flex" style="flex-direction:row">
                    <div class="card-img position-relative" style="width: 30%">
                    ...
                    <div class="card-body gallery-card">
                        <div class="row justify-content-between m-0 mt-2 mb-3 align-items-center">
                            ...
                            <div class="w-auto list-icons-gallery p-0">
                                ...
                                <a class="share" data-toggle="modal" data-target="#shareLinkUnitx{{ $unit->id }}"
                                    href=""
                                    onclick="document.querySelector('#shareLinkUnitx{{ $unit->id }} ul.share-tabs.nav.nav-tabs li:first-child a').click()">
                        ...
                        <div class="row justify-content-between gap-3 m-0 p-0 mt-3">
                            <div class="w-auto d-flex service-iconss gap-4 p-0">
                                ...
                                <div class="bathrooms w-auto d-flex" style="height: fit-content;">
                                    <div class="cont"
        ...
        <div class="modal fade" id="shareLinkUnitx{{ $unit->id }}" tabindex="-1" role="dialog"
            aria-labelledby="shareLinkTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <ul class="share-tabs nav nav-tabs">
                            <li class="shareLinkUnitx{{ $unit->id }} active"><a
                                    href="#shareLinkUnitx{{ $unit->id }}"
                                    onclick="share('shareLinkUnitx{{ $unit->id }}')">مشاركة الرابط</a>
                            </li>
                            <li class="qrCodeUnitx{{ $unit->id }}"><a href="#qrCodeUnitx{{ $unit->id }}"
                                    onclick="share('qrCodeUnitx{{ $unit->id }}')">qr code</a></li>
                    ...
                    <div class="modal-body share-divs">
                        <div id="shareLinkUnitx{{ $unit->id }}" class="first">
                            <h6>مشاركة الرابط</h6>
                        ...
                        <div id="qrCodeUnitx{{ $unit->id }}" class="second">
                            ...
                            <div class="row pb-5 pt-4 flex-nowrap align-items-center">
                                ...
                                <div class="d-flex gap-4" style="flex: auto;flex-direction:column">
                                    ...
                                    @php
                                        $url = "route('gallery.showUnitPublic', ['gallery_name' => $unit->gallery_name, 'id' => $unit->id])";
                                    @endphp
                                    <a href=""
