    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md mb-md-0 mb-3">
                    <div class="form-check custom-option custom-option-icon" @if ($sitting->active_broker == 1)
                        onclick="redirectToIdNumber('broker')"
                    @endif>
                        <label class="form-check-label custom-option-content" for="customRadioHome">
                            ...
                            <input name="customRadioIcon" class="form-check-input"
                             {{ $sitting->active_broker == 1 ? '' : 'disabled' }} type="radio" value="" id="customRadioHome" checked />
                        </label>
                    </div>
                </div>
                ...
                <div class="col-md mb-md-0 mb-3">
                    <div class="form-check custom-option custom-option-icon"
                     @if ($sitting->active_office == 1) onclick="redirectToIdNumber('office')" @endif>
                ...
                <div class="col-md mb-md-0 mb-3">
                    <div class="form-check custom-option custom-option-icon"
                    @if ($sitting->active_property_finder == 1) onclick="redirectToIdNumber('property_finder')" @endif>
                        <label class="form-check-label custom-option-content" for="customRadioFinder">
                            <span class="custom-option-body">
                                ...
                                <span class="custom-option-title">@lang('Property Finder')
