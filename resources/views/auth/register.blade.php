    ...
    <div class="wrapper-page">
        <div class="card card-pages shadow-none">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal m-t-30" id="register" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            ...
                            <input type="text"
                                class="form-control @error('commercial_registry') is-invalid @enderror"
                                id="commercial_registry" name="commercial_registry" placeholder="ادخل رقم السجل التجاري"
                                value="{{ old('commercial_registry') }}" required autocomplete="commercial_registry"
                                autofocus>
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="company_name" name="company_name"
                                placeholder="ادخل اسم الشركة" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="representative_name" name="representative_name"
                            placeholder="ادخل اسم الممثل" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="tel" class="form-control" id="representative_whatsapp"
                                name="representative_whatsapp" placeholder="599123456" required>
                        </div>
                    </div>
