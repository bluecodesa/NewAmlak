...
document.addEventListener("DOMContentLoaded", function () {
    (function () {
        ...
        //             contactListItem0 = document.querySelector(
        //                 ".contact-list-item-0"
        //             ),
        ...
        function searchChatContacts(
            ...
            searchListItems.forEach((searchListItem) => {
                let searchListItemText =
                    searchListItem.textContent.toLowerCase();
                if (searchValue) {
        ...
        formSendMessage.addEventListener("submit", (e) => {
            ...
            if (messageInput.value) {
                ...
                renderMsg.innerHTML =
                    '<p class="mb-0 text-break">' + messageInput.value + "</p>";
                document
        ...
        let chatHistoryHeaderMenu = document.querySelector(
            ...
            chatSidebarLeftClose = document.querySelector(
