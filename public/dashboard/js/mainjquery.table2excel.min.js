...
!(function (a, b, c, d) {
    ...
    var j = "table2excel",
        k = { exclude: ".noExl", name: "Table2Excel" };
    (e.prototype = {
        init: function () {
            var b = this;
            (b.template = {
                        ...
                        .each(function (c, d) {
                            (e += "<tr>"),
                                a(d)
                                    ...
                                    .not(b.settings.exclude)
                                    .each(function (c, d) {
                                        a(d).find(b.settings.exclude).length >=
                                        1
                                            ? (e += "<td> </td>")
                                            : (e +=
                                                  "<td>" +
        ...
        tableToExcel: function (d, e, g) {
            ...
            if (((l += k.template.mid), a.isArray(d)))
                for (h in d)
                    l +=
                        k.template.table.head +
                        "{table" +
                        h +
                        "}" +
                        k.template.table.tail;
            l += k.template.foot;
        ...
        (a.fn[j] = function (b) {
            ...
            return (
                c.each(function () {
                    a.data(c, "plugin_" + j) ||
                        a.data(c, "plugin_" + j, new e(this, b));
                }),
                c
            );
        });
