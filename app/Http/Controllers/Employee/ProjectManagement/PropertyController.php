...
use App\Services\Office\Employee\PropertyService;
...
class PropertyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Office.Employee.ProjectManagement.Project.Property.index',  get_defined_vars());
    }
    ...
    public function create()
    {
        ...
        return view('Office.Employee.ProjectManagement.Project.Property.create', get_defined_vars());
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Employee.Property.index')->with('success', __('added successfully'));
    }

    public function show($id)
    {
        $Property = $this->PropertyService->findById($id);
        return view('Office.Employee.ProjectManagement.Project.Property.show',  get_defined_vars());
    }
    ...
    public function edit($id)
    {
        ...
        return view('Office.Employee.ProjectManagement.Project.Property.edit', get_defined_vars());
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('Employee.Property.index')->with('success', __('Update successfully'));
    }

    public function destroy(string $id)
    {
        $this->PropertyService->delete($id);
        return redirect()->route('Employee.Property.index')->with('success', __('Deleted successfully'));
    }
    ...
    function CreateUnit($id)
    {
        ...
        return view('Office.Employee.ProjectManagement.Project.Property.CreateUnit', get_defined_vars());
    }
    ...
    function StoreUnit(Request $request, $id)
    {
        ...
        return redirect()->route('Employee.Property.show', $id)->with('success', __('added successfully'));
    }
