...
class UnitController extends Controller
{
    ...
    function SaveNewOwners(Request $request)
    {
        ...
        $owners = $this->officeDataService->getOwners();
        return view('Office.Employee.ProjectManagement.Project.Unit.inc._owners', compact('owners'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Employee.Unit.index')->with('success', __('added successfully'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($Unit->property_id != null) {
            return redirect()->route('Employee.Property.show', $Unit->property_id)->with('success', __('Update successfully'));
        }
        return redirect()->route('Employee.Unit.show', $Unit->id)->with('success', __('Update successfully'));
    }

    public function destroy(string $id)
    {
        $this->UnitService->delete($id);
        return redirect()->route('Employee.Unit.index')->with('success', __('Deleted successfully'));
    }

    public function destroyUnitGallery(string $id)
    {
        $this->UnitService->delete($id);
        return redirect()->route('Employee.Gallery.index')->with('success', __('Deleted successfully'));
    }
