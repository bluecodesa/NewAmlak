...
class SystemInvoiceController extends Controller
{
    ...
    {
        $invoices = SystemInvoice::all();
        return view('Admin.subscribers.invoices.index', get_defined_vars());
    }
    ...
    {
        $invoice = SystemInvoice::find($id);
        return view('Admin.subscribers.invoices.show', get_defined_vars());
    }
