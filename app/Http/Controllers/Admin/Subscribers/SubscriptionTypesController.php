...
class SubscriptionTypesController extends Controller
{
    ...
    //     $types = $this->subscriptionTypeRepository->index($status_filter, $period_filter, $price_filter);
    //     $prices = $this->subscriptionTypeRepository->calculateRange($types->pluck('price')->toArray());
    ...
    // public function store(Request $request)
    // {
    //     return $this->subscriptionTypeService->store($request->all());
    // }

    // public function update(Request $request, $id)
    // {
    //     return $this->subscriptionTypeService->update($request->all(), $id);
    // }

    // public function deleteMultiType(Request $request)
    // {
    //     return $this->subscriptionTypeService->deleteMultiType($request->get('ids'));
    // }

    // public function destroy($id)
    // {
    //     return $this->subscriptionTypeService->destroy($id);
    // }
